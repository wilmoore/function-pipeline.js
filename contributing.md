# Contributing to function-pipeline

Below are a few ways to make contributing to `function-pipeline` smoother.
...
## Setup
    ...
    git clone https://github.com/wilmoore/function-pipeline.js.git
    cd function-pipeline.js
    npm install
    npm run dev
